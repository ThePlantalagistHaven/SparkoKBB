...
triggerall = numhelper(21005) = 0 && numhelper(21010) = 0
...
value = 27000
triggerall = numhelper(3500) = 0
triggerall = command = "SPECIAL COUNTER"
Triggerall = statetype != A
Triggerall = power >= 500
trigger1 = ctrl
;---------------------------------------------------------------------------
...
value = 28000
triggerall = numhelper(3500) = 0
triggerall = command = "SPECIAL SUPER"
Triggerall = statetype != A
...
triggerall = numhelper(452) < 2
triggerall = numhelper(454) < 2
Triggerall = statetype != A
trigger1 = ctrl
;---------------------------------------------------------------------------
; C
...
triggerall = command = "holddown"
triggerall = command = "c"
triggerall = numhelper(632) < 2
triggerall = numhelper(634) < 2
Triggerall = statetype = A
trigger1 = ctrl
;---------------------------------------------------------------------------
; C Aire
...
[state -1, 2C AI]
Type = Changestate
Triggerall=var(59)>0 && stateno = 40
triggerall = numhelper(3500) = 0 
triggerall = numhelper(452) <= 1
Triggerall = power >= 200
Triggerall= Statetype = S  
Triggerall= ifelse(aiLevel >= 8, 1, random < (ailevel ** ailevel) + 500)
Triggerall = ctrl
...
Triggerall=abs(P2Bodydist X)<20 
Triggerall=P2StateType=S
Triggerall=random < (ailevel ** ailevel) + 4500
...
;[state -1, A3-B AI]
;Type = Changestate
;Triggerall = stateno = 222 && movehit = 1
;Triggerall=var(59)>0 
;Triggerall= Statetype = S 
;Triggerall=abs(P2Bodydist X)<40 
;Triggerall=P2StateType=S
;Triggerall=random < (ailevel ** ailevel) + 500
;Trigger1 = Stateno = 222  && movehit = 1
;trigger3 = enemy,movetype != A
;value = 224
;
;[state -1, B AI]
